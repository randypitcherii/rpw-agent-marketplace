# RPW Tasks (Raycast Starter)

Low-priority starter extension for drafting `human-todo` task entries from Raycast.
...
- Integrate direct writes to a real task backend (GitHub or Google Tasks).
